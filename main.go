...
import (
	...
	"gitlab.com/waldirborbajr/nfeloader/pkg/config"
	"gitlab.com/waldirborbajr/nfeloader/pkg/customlog"
	"gitlab.com/waldirborbajr/nfeloader/pkg/mail"
	"gitlab.com/waldirborbajr/nfeloader/pkg/repository"
	"gitlab.com/waldirborbajr/nfeloader/pkg/service"
	"gitlab.com/waldirborbajr/nfeloader/pkg/xml"
)
...
func init() {
	log.Info().Msg(".\n")
	log.Info().Msg("Starting NFeLoader " + version + "\n")
