-- DROP USER nfeloader;
CREATE DATABASE IF NOT EXISTS `nfeloader`;
USE nfeloader;
CREATE USER 'nfeloader'@'%' IDENTIFIED BY '123Mudar';
ALTER USER 'nfeloader'@'%' IDENTIFIED BY '123Mudar';
GRANT ALL PRIVILEGES ON nfeloader.* TO 'nfeloader'@'%';
FLUSH PRIVILEGES;

SET GLOBAL FOREIGN_KEY_CHECKS=0;

-- Create syntax for TABLE 'nfe'
CREATE TABLE `nfe` (
  ...
  `nfref_refNFe` varchar(100) DEFAULT NULL COMMENT 'nfref_refNFe',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `ide_nNF` (`ide_nNF`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;

-- Create syntax for TABLE 'nfedetalhe'
